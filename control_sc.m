...
max_it='1000000 '; %max number of iterations per Pc
save_it='5000 '; %saves gifs
vtk_it='10000 '; %saves the density
info_it='500 ';%displays info and checks for convergence (this might be inneficient)
convergence='0.001 '; %check thesis
start_no='0 '; %no of first realization
run_no='10 '; %number of densities. number of Pc
...
nz2f2='254 ';
rho_no_fluid='0.06 ';
cap_factor='1.0 '; %not used annymore
...
if send_batch==true
    system(['sbatch -np XX batchjob_',exp_name])
else
